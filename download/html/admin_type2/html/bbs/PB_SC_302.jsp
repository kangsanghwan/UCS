...
<section id="content" class="content">
    ...
    <div class="bt-area text-right">
        <button type="button" onclick="location.href='PB_SC_304.jsp'" class="bt reset">수정</button>
        <button type="button" class="bt reset">삭제</button>
        <button type="button" onclick="location.href='PB_SC_301.jsp'" class="bt list">목록</button>
    </div>
</section>
<!-- /Contents -->
